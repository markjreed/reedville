...
<table width="290" cellspacing="1" cellpadding="1">
 <tr>
  <td bgcolor="#0080c0" width="58"><a href="consequence.php"><img class="plain"
    alt="First Letter" src="first.png" onmouseover="swap(this,'first_active.png')" onmouseout="unswap(this)"/></a></td>
  <td bgcolor="#0080c0" width="58"><a href="consequence.php"><img class="plain" 
    alt="Previous Letter" src="back.png" onmouseover="swap(this,'back_active.png')" onmouseout="unswap(this)"/></a></td>
  <td bgcolor="#0080c0" width="58"><a href="letters.php"><img class="plain"
    alt="Letters List" src="up.png" onmouseover="swap(this,'up_active.png')" onmouseout="unswap(this)"/></a></td>
  <td bgcolor="#0080c0" width="58"><a href="distribution.php"
><img class="plain" alt="Next Letter" src="forward.png"" onmouseover="swap(this,'forward_active.png')" onmouseout="unswap(this)"/></a></td>
  <td bgcolor="#0080c0" width="58"><a href="rezoneletterda.php"><img class="plain"
