...
function Calendar(day, month, year, element_ids)
{
    var now = new Date();
    if (!day)
    {
...
Calendar.WEEKDAYS = [ 'Sunday', 'Monday', 'Tuesday', 'Wednesday', 
